...
class Scraper(HTMLCouncillorScraper):
    ...
    def get_single_councillor(self, councillor_html):
        ...
        division = soup.select_one(".views-field-field-ward").get_text(strip=True).replace("Ward:", "")
        party = soup.select_one(".views-field-field-party").get_text(strip=True).replace("Party:", "")
